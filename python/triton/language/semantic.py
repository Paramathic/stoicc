...
def make_block_ptr(base: tl.tensor, shape, strides, offsets, block_shape, order, builder: ir.builder) -> tl.tensor:
    ...
    # If the pointer is sparse, then the value is
    #   `pointer_type<blocked<shape,element_type, #sparsity_encoding>> in Python
    #   `tt.ptr<tensor<shape, element_type, #sparsity_encoding>>` in MLIR
