...
def str_to_ty(name):
    #if name.split('_')[0] == "sparse":
    if name.startswith("sparse"):
        # The sparse pointer type string has the following format:
        # sparse_<element_type>_<sparsity_format>
        #   element type is a primitive type
        #   sparsity format is one of the elements in Compressor.supported_compressions
        name = name.split('_')
